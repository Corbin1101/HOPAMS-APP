        ...
        function updateEvents(date) {
            ...
            eventsArr.forEach((event) => {
              if (
                ...
                event.events.forEach((mdata) => {
                  const startTime = new Date(mdata.appointment_date); // Convert appointment_date to a Date object
                  const endTime = new Date(startTime.getTime() + 30 * 60000); // Add 30 minutes to the start time for the appointment duration
                  const eventData = {
                    start: startTime,
                    end: endTime,
                    title: `Doctor: ${mdata.doc_fullname} | Patient: ${mdata.pat_fullname}`,
                  };
